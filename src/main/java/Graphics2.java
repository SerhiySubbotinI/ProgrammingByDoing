...
public class Graphics2 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        //arcs
        g.drawArc(270,20,100,200,0,200); // draw an arc that starts at 0 degrees
        ...
        // custom colors
        Color myOrange = new Color(200,92,5); // the amount of red, green, blue in the color
        // Each component has a value from 0-255.
        g.setColor(myOrange);
        g.fillOval(500,50,150,150);

        Color myGrey = new Color(50,70,95);
        g.setColor(myGrey);
    ...
    {
        JFrame win = new JFrame("Graphics2");
        win.setSize(800,600);
